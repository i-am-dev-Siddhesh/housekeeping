...
exports.checkIpLocation = exports.checkToken = exports.checkAdminToken = exports.checkUserButStillAllowRoute = exports.checkApiKey = void 0;
...
const checkUserButStillAllowRoute = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (authorization || (authorization === null || authorization === void 0 ? void 0 : authorization.startsWith('Bearer '))) {
            ...
            if (decoded) {
                const phoneNumber = decoded === null || decoded === void 0 ? void 0 : decoded.phoneNumber.replace('+91', '');
...
const checkAdminToken = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        const token = (_b = (_a = req === null || req === void 0 ? void 0 : req.cookies) === null || _a === void 0 ? void 0 : _a.auth) === null || _b === void 0 ? void 0 : _b.token;
        if (!token) {
            throw {
...
const checkToken = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const decoded = (0, auth_1.decodeJWTToken)(idToken, 'user');
        const phoneNumber = decoded === null || decoded === void 0 ? void 0 : decoded.phoneNumber.replace('+91', '');
        const user = (yield prisma_1.prisma.worker.findUnique({
            where: {
                phoneNumber,
            },
        }));
